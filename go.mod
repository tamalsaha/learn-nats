...
require (
	...
	go.bytebuilders.dev/license-proxyserver v0.0.4 // indirect
	...
	kmodules.xyz/resource-metadata v0.17.2 // indirect
	kmodules.xyz/resource-metrics v0.25.2 // indirect
	kubepack.dev/lib-helm v0.7.0 // indirect
...
replace (
	...
	helm.sh/helm/v3 => github.com/x-helm/helm/v3 v3.10.2-0.20230503230011-a8f5ce951c95
